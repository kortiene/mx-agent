...
// and override stale framing in the reused bodies. The preamble text is carried
// VERBATIM from adw/_phases.py:371-396 (it is the prompt-level half of the D5
// boundary and must not drift between engines).
